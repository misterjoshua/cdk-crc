      ...
      <div className="container">
        ...
        <section>
          ...
          <p>
            ...
            <br />
            Developed software for real estate, insurance, medical, financial,
            oil & gas, and entertainment sectors since 2003.
          </p>
        ...
        <section>
          ...
          <section>
            ...
            <ul>
              <li>
                Provided end-to-end services for Calgary-area businesses
                requiring cloud-native solutions and consulting for Amazon,
              ...
              <li>
                Produced CI/CD pipelines for infrastructure, application code,
                and automated functional testing.
              </li>
              <li>
                Performed deployment following the Infrastructure as Code
                paradigm with CloudFormation and Azure Resource Manager
                templates.
              </li>
              <li>
              ...
              <li>
                Created Kubernetes-native RESTful services with client-go.
              </li>
              <li>
          ...
          <section>
            ...
            <ul>
              <li>
                ...
                client projects to ensure the highest standards of consistency
                and quality in development processes, delivered products, and
                services.
              </li>
              <li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                Produced bespoke e-commerce systems, membership portals,
                websites, web integrations, and white-label services.
              </li>
              <li>
                Customized and deployed off-the-shelf software, including
                Dynamics CRM.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                Performed maintenance on a large mortgage processing monolith
                and was instrumental in the technology-related decision-making
                and planning at the company.
              </li>
              <li>
                Maintained websites and a mortgage processing backend.
                Integrated the backend with both major mortgage origination
          ...
          <section>
            ...
            <ul>
              <li>
                Developed software for both the front-end and backend server
                code for a small game studio, maintaining and adding
                functionality to two large C++ codebases.
              </li>
              <li>
